...
<body>
        ...
        <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
            ...
            <div class="flex md:order-2">
                ...
                <button type="button" class="flex mx-3 text-sm bg-gray-800 rounded-full md:mr-0 focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600" id="user-menu-button" aria-expanded="false" data-dropdown-toggle="user-dropdown" data-dropdown-placement="bottom">
                    ...
                    <img class="w-8 h-8 rounded-full" src="assets/profile/user-solid.svg" alt="user photo">
                </button>
                <!-- Dropdown menu -->
                        ...
                        <div id="mega-menu-dropdown" class="absolute z-10 grid hidden w-auto grid-cols-2 text-sm bg-white border border-gray-100 rounded-lg shadow-md dark:border-gray-700 md:grid-cols-3 dark:bg-gray-700">
                            <div class="p-4 pb-0 text-gray-900 md:pb-4 dark:text-white">
                                <ul class="space-y-4" aria-labelledby="mega-menu-dropdown-button">
                                    ...
                                    ?>
                                        <li>
                                            <a href="index.php?kategori=<?= $kategoriBuku['id'] ?>" class="text-gray-500 dark:text-gray-400 hover:text-blue-600 dark:hover:text-blue-500">
    ...
    <div class="container pt-20 mx-10 md:mx-auto">

        <?php
        if ($dataBuku['status'] == 'Berhasil') {
            foreach ($dataBuku['data'] as $books) {
        ?>
                <div class="flex text-sm md:text-xl text-slate-600 mb-10 pb-10 border-b-2">
                    <div class="poster w-[400px] mr-5">
                        <img src="assets/data_buku/<?= $books['cover_buku'] ?>" alt="">
                    </div>
                    <div class="detail space-y-5">
                        <div class="judul flex space-x-4">
                            <p class="font-bold"><?= $books['judul'] ?></p>
                        </div>
                        <div class="deskripsi flex space-x-4">
                            <p><?= $books['deskripsi'] ?></p>
                        </div>
                        <div class="kategori flex space-x-4">
                            <p>Kategori : <?= $books['kategori'] ?></p>
                        </div>
                        <div class="aksi flex space-x-4">
                            <a href="detail_buku.php?id=<?= $books['id'] ?>" class="px-2 md:px-5 py-1 md:py-2 rounded bg-gray-500 text-white">Lihat Detail</a>
                            <a href="" class="px-2 md:px-5 py-1 md:py-2 rounded bg-gray-500 text-white">Edit</a>
                        </div>
                    </div>
                </div>
        <?php
